...
public final class DateTimeBean {
    ...
    /// Propriétés
    public ObjectProperty<LocalDate> dateProperty  = new SimpleObjectProperty<>(null);
    public ObjectProperty<LocalTime> timeProperty  = new SimpleObjectProperty<>(null);
    public ObjectProperty<ZoneId> zoneProperty     = new SimpleObjectProperty<>(null);
