...
public final class SkyCanvasManager {
    ...
    private static final double CLOSEST_RANGE                       = 10d;
    ...
    public SkyCanvasManager(StarCatalogue catalogue, DateTimeBean dateTimeB,
        ...
        dilationFactor = Bindings.createDoubleBinding(
                () -> DEFAULT_WIDTH / projection.getValue().applyToAngle(
         ...
         * s'il y en a un, situé au maximum à 10 unités dans le repère du canevas.
         */
        ...
        projection.addListener(painterListener);
